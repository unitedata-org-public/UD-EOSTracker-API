...
}, 'snc_redis.command.flush_all' => function () {
    $f = function (\Snc\RedisBundle\Command\RedisFlushallCommand $v) { return $v; }; return $f(${($_ = isset($this->services['snc_redis.command.flush_all']) ? $this->services['snc_redis.command.flush_all'] : $this->load('getSncRedis_Command_FlushAllService.php')) && false ?: '_'});
}, 'snc_redis.command.flush_db' => function () {
    $f = function (\Snc\RedisBundle\Command\RedisFlushdbCommand $v) { return $v; }; return $f(${($_ = isset($this->services['snc_redis.command.flush_db']) ? $this->services['snc_redis.command.flush_db'] : $this->load('getSncRedis_Command_FlushDbService.php')) && false ?: '_'});
