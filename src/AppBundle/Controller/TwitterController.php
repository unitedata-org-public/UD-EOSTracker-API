...
{
    /**
     * @Route("/eosapi/tweets", name="tweets")
     */
    ...
    /**
     * @Route("/eosapi/tweets/stats", name="tweets_stats")
     */
    ...
    /**
     * @Route("/eosapi/tweets/{username}", name="tweets_user")
     */
    ...
    /**
     * @Route("/eosapi/tweets/{username}/avatar.png", name="tweets_user_avatar")
     */
    ...
    /**
     * @Route("/eosapi/tweets/{username}/stats", name="tweets_user_stats")
     */
