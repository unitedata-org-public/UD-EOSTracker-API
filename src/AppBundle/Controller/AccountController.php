...
{
    /**
     * @Route("/eosapi/accounts", name="accounts")
     */
    ...
    /**
     * @Route("/eosapi/accounts/{name}", name="account")
     */
    ...
    /**
     * @Route("/eosapi/accounts/key/{key}", name="account_by_key")
     */
    ...
    /**
     * @Route("/eosapi/accounts/{name}/actions", name="account_actions")
     */
    ...
    /**
     * @Route("/eosapi/accounts/{name}/actions/to", name="account_actions_to")
     */
