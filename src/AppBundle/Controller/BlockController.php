...
{
    /**
     * @Route("/eosapi/blocks", name="blocks")
     */
    ...
    /**
     * @Route("/eosapi/blocks/{id}", name="block")
     */
    ...
    /**
     * @Route("/eosapi/blocks/id/{id}", name="block_by_id")
     */
    ...
    /**
     * @Route("/eosapi/blocks/{id}/transactions", name="block_transactions")
     */
