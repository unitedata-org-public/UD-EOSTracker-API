...
DQL
    ...
    public function countLast(int $hours): int
    {
        ...
        $sql = "SELECT count(a.id) as cant FROM tk_actions a JOIN tk_transactions t ON a.transaction_id = t.id WHERE t.created_at > '".date_format($datetime, 'Y-m-d H:i:s')."' LIMIT 1";
